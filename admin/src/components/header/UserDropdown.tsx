...
// Import the ProfileImage component for consistent image handling
const ProfileImage = ({ 
  src, 
  alt, 
...
export default function UserDropdown() {
  ...
  // Get the user's full name or a fallback
  ...
  const profileImageUrl = user?.profile?.profile_picture 
    ? user.profile.profile_picture.startsWith('http') 
      ? `${user.profile.profile_picture}?t=${timestamp}` 
      : `${API_URL.replace('/api', '')}${user.profile.profile_picture}?t=${timestamp}`
