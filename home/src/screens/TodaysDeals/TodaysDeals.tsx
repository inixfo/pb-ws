...
export const TodaysDeals = (): JSX.Element => {
  // Pagination and sort
  ...
  React.useEffect(() => {
    const fetchTodaysDeals = async () => {
      try {
        ...
        console.log("Fetched today's deals:", products);
        ...
        setError("Failed to load today's deals products");
        setProducts([]);
      } finally {
        setLoading(false);
      }
      ...
      <main className="w-full max-w-[1296px] mx-auto px-4 sm:px-6 lg:px-8 mt-6 sm:mt-8 md:mt-10 mb-10 sm:mb-16 md:mb-20">
        ...
        <div className="pt-4 sm:pt-6 md:pt-8 pb-2 px-0">
          <div className="flex items-center gap-2 text-xs text-gray-500 mb-2">
            ...
            <span className="text-gray-400">Today's Deals</span>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 mt-6">
          ...
          {mobileFiltersVisible && (
            ...
            >
              ...
              {/* Mobile filter content - complete implementation */}
              <div className="space-y-6 max-h-[calc(100vh-120px)] overflow-y-auto pb-4">
                {/* Categories */}
                <div>
                  <h3 className="text-base font-medium mb-3">Categories</h3>
                  <div className="space-y-3">
