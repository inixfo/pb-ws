  ...
  React.useEffect(() => {
    const fetchTrendingProducts = async () => {
      try {
        ...
        console.log('Fetched trending products:', products);
      ...
      <main className="w-full max-w-[1296px] mx-auto px-4 sm:px-6 lg:px-8 mt-6 sm:mt-8 md:mt-10 mb-10 sm:mb-16 md:mb-20">
        ...
        <div className="pt-4 sm:pt-6 md:pt-8 pb-2 px-0">
          <div className="flex items-center gap-2 text-xs text-gray-500 mb-2">
            ...
            <span className="text-gray-400">Trending Products</span>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-6 mt-6">
          ...
          <div className="flex-1">
            ...
            {!loading && !error && products.length === 0 && (
              <div className="text-center py-12">
                <h3 className="text-lg font-medium text-gray-900 mb-2">No trending products found</h3>
                <p className="text-gray-500 mb-4">Check back later for exciting trending products</p>
              </div>
            )}
